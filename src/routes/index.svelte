  ...
  $: screenWidth = window.screen.availWidth
	...
	onMount(async () => {
		...
		if(firstTime && food.length === 0) {
			food = [
				{name: 'cup milk 2%', protein: 8, carbs: 12, fat: 4.9},
				{name: 'cup oatmeal', protein: 6, carbs: 27, fat: 3.2},
				{name: 'egg', protein: 6, carbs: 0.6, fat: 5},
				{name: '100g chicken breast', protein: 31, carbs: 0, fat: 3.6},
				{name: '100g brown rice', protein: 2.6, carbs: 23, fat: 0.9},
				{name: '100g japanese potato', protein: 1.4, carbs: 37, fat: 0.2},
				{name: 'avocado', protein: 4, carbs: 17, fat: 29},
				{name: 'half avocado', protein: 2, carbs: 8.5, fat: 14.5},
				{name: 'tbsp olive oil', protein: 0, carbs: 0, fat: 14},
				{name: 'cup cottage cheese 2%', protein: 27, carbs: 8, fat: 6},
				{name: '100g greek yugurt', protein: 10, carbs: 3.6, fat: 0.4},
